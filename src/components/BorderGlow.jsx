...
function parseHSL(hslStr) {
  ...
  if (!match) return { h: 28, s: 100, l: 58 }
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: lightSurface ? 'rgb(36 36 36 / 10%)' : 'rgb(255 255 255 / 15%)',
        borderRadius: `${borderRadius}px`,
        transform: 'translate3d(0, 0, 0.01px)',
        boxShadow: lightSurface
          ? 'rgb(36 36 36 / 3%) 0 1px 2px, rgb(36 36 36 / 5%) 0 10px 28px'
          : 'rgba(0,0,0,0.12) 0 8px 24px',
      }}
    >
      <div
        className="border-glow__mesh border-glow__mesh--border"
        style={{
      ...
      <div
        className="border-glow__mesh border-glow__mesh--fill"
        style={{
          border: '1px solid transparent',
      ...
      >
        <span
          className="border-glow__outer-inner"
          style={{
            inset: `${glowRadius}px`,
